...
- Por sua vez, o /momentum/ linear de um sistema composto de \(N\)
  partículas pode ser obtido utilizando o *{{{yellow(princípio de substituição)}}}*
...
[[file:~/Dropbox/UFSCar/2025_Aulas/1002317_FisExpIMec/aulas/img/forcas.png]]
...
\begin{align*}
\frac{\mathrm{d}K}{\mathrm{d}t} &= \frac{\vec{p}_2}{m_2}\cdot \frac{\mathrm{d}\vec{p}_2}{\mathrm{d}t}
...
[[file:~/Dropbox/UFSCar/2025_Aulas/1002317_FisExpIMec/aulas/img/col1dapprox.png]] 
\begin{align*}
v_{approx} &= v_1-v_2
\end{align*}
...
:END:
#+attr_html: :scale 12
[[file:~/Dropbox/UFSCar/2025_Aulas/1002317_FisExpIMec/aulas/img/col1dafast.png]] 
\begin{align*}
v_{afast} &= v'_1-v'_2
\end{align*}
